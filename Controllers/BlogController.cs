...
namespace BlogMVCApp.Controllers
{
    public class BlogController : Controller
    {
        ...
        public ActionResult List(int? id,string Anahtar)
        {
            ...
            if (string.IsNullOrEmpty("Anahtar")==false)
            {
                bloglar = bloglar.Where(i => i.Baslik.Contains(Anahtar) || i.Aciklama.Contains(Anahtar));
            }
            if (id != null)
            {
